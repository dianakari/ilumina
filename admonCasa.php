    ...
    <section>
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-8">
            <br><br><br><br>
            <h2 class="text-center">Administrador de Casas</h2>
            <br>
            ...
            <?php
              ...
              if ($resultado->num_rows>0){
                ...
                echo "<th> No </th><th> Nombre </th> <th>Ap. Paterno </th> <th>Ap. Materno</th>";
                echo "<th> Ver </th><th> Eliminar </th>";
                while($fila=$resultado->fetch_assoc()){
                echo "<tr>";
                echo "<td>".$fila['idcasa']."</td>";
                echo "<td>".$fila['nomDueño']."</td>";
                echo "<td>".$fila['apDueño']."</td>";
                echo "<td>".$fila['amDueño']."</td>";
                echo "<td><a href='verCasa.php?idcasa=". $fila['idcasa']."'><i class='fas fa-eye'></i> </a></td>";
                echo "<td> <a href='metodosCasa.php?opcion=2&idcasa=".$fila['idcasa']."'><i class='fas fa-trash-alt'></i></a></td>";
              }
            }
                echo "</center>";
            ?>
